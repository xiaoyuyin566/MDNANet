...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.model   == 'MDNANet':
            model       = MDNANet(num_classes=1,input_channels=args.in_channels, block=Res_CBAM_block, num_blocks=num_blocks, nb_filter=nb_filter, deep_supervision=args.deep_supervision)
        # elif args.model == 'ACM':
        ...
        # Checkpoint
        checkpoint        = torch.load('E:\\Infrared-Small-Target-Detection-master\\result\\' + args.model_dir)
